...
#Peter Spijker, 2016 https://github.com/SINGROUP/Bader_charges/blob/master/README.md
import numpy,sys
...
#HERE I modified the valence dictionary and added the ZVAL of Pd, Pt and S, Br, I, S, Au. - -LPGM
# TO DO... Add the path of the POTCAR and extract the ZVAL value. - LPGM

# Dictionary with valence numbers. 
valence = {'C':4,'H':1,'N':5,'O':6,'Co':17, 'Pd':10, 'Pt':10}
#TO DO add the potcar directory so that it can saerch for ZVAL within the POTCAR file for VASP
